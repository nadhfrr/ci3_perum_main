        ...
        <div class="col-lg">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    <a href="<?php echo site_url('detailrab/indexdata/' . $kd_proyek . '') ?>"><i class="fas fa-arrow-left"></i> Kembali</a>
                </div>
                <div class="card-body">
                                    ...
                                    <div class="modal fade" id="tolakValidasiModal<?php echo $dp->id_pekerjaan ?>" tabindex="-1" aria-labelledby="tolakValidasiModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <form action="<?= base_url('detailpekerjaan/tambah_catatan/' . $dp->id_pekerjaan . '') ?>" method="post" enctype="multipart/form-data">
                                                    <input type="text" name="kd_proyek" id="" value="<?php echo $dp->kd_proyek ?>" hidden>
                                                    <input type="text" name="id_rab" id="" value="<?php echo $dp->id_rab ?>" hidden>
