							...
							<tbody>
								<?php foreach ($proyek as $proyek) : ?>
									<tr>
										...
										<td width="300">
											<a href="<?php echo site_url('detailrab/indexdata/' . $proyek['kd_proyek']) ?>" class="btn btn-small text-info"><i class="fas fa-info-circle"></i> Detail</a>
											<a href="<?php echo site_url('proyek/indexrab/' . $proyek['kd_proyek']) ?>" class="btn btn-small text-info"><i class="fas fa-info-circle"></i> RAB</a>
