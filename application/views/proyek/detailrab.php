        ...
        <div class="col-lg">
            ...
            <div class="card mb-3">
                <div class="card-header">
                    ...
                    <a href="<?php echo site_url('proyek/addpekerjaan/') ?>" class="btn btn-primary" style="float:right"><i class="fas fa-plus"></i> Tambah Jenis Pekerjaan</a>
                            ...
                            <tbody>
                                <?php foreach ($detailrab as $detailrab) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= site_url('proyek/detailpekerjaan/' . $kd_proyek . '/' . $detailrab['id_rab']) ?>" class="btn btn-small text-info"><i class="fas fa-info-circle"></i>
                                                Detail</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
